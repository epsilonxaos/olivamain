                        ...
                        <div id="tab-content-secc2">
                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="es-secc2" role="tabpanel"
                                ...
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="events_s1_title">Título</label>
                                    <textarea name="events_s1_title[es]" class="shorttext" cols="30" rows="3">{{ $data->{'events_s1_title:es'} }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="events_s1_text">Contenido</label>
                                    <textarea name="events_s1_text[es]" class="shorttext" cols="30" rows="3">{{ $data->{'events_s1_text:es'} }}</textarea>
                                </div>
                            </div>
                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="en-secc2" role="tabpanel"
                                ...
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="events_s1_title">Título</label>
                                    <textarea name="events_s1_title[en]" class="shorttext" cols="30" rows="10">{{ $data->{'events_s1_title:en'} }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="events_s1_text">Contenido</label>
                                    <textarea name="events_s1_text[en]" class="shorttext" cols="30" rows="10">{{ $data->{'events_s1_text:en'} }}</textarea>
                                </div>
                            </div>
                        </div>
