...
@section('content')
    ...
    <div class="relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden">
        ...
        <!-- ===== Main Content Start ===== -->
        <main>
            <div class="mx-auto max-w-screen-lg p-4 md:p-6 2xl:p-10 flex items-center">

                <!-- ====== Forms Section Start -->
                <div
                    class="rounded-sm border w-full border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                    <div class="flex flex-wrap items-center">
                        <div class="hidden w-full xl:block xl:w-1/2">
                            <div class="py-17.5 px-26 text-center">
                                ...
                                {{-- <img class="mb-3" src="./images/logo/logo.svg" alt="Logo" /> --}}

                                <span class="mt-15 inline-block">
                                    <svg width="280" height="350" viewBox="0 0 350 350" fill="none"
                        ...
                        <div class="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                            <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                                <p class="font-medium mb-4 text-center">
                                ...
                                <form method="POST" action="{{ route('panel.login') }}">
                                    @csrf
                                    <div class="mb-4">
                                        <label class="mb-2.5 block font-medium text-black dark:text-white">Correo
                                            electrónico</label>
                                        <div class="relative">
                                    ...
                                    <div class="mb-5">
                                        <input type="submit" value="Ingresar"
                                            class="w-full cursor-pointer rounded-lg border border-blue-500 bg-blue-500 p-4 font-medium text-white transition hover:bg-opacity-90" />
                                    </div>

                                    <div class="mt-6 text-center">
                                        <p class="font-medium">
                                            <a href="{{ env('APP_URL') }}" class="text-blue-700">Regresar al sitio
                                                prinicipal</a>
                                        </p>
                                    </div>
                                </form>
